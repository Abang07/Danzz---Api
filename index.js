...
// ═══════════════════════════════════════════════════
// META MAP — fallback kalau file JS tidak export meta
// key = nama file tanpa .js
// ═══════════════════════════════════════════════════
const ENDPOINT_META = {
  // ai
...
fs.readdirSync(apiDir).forEach(category => {
  ...
  fs.readdirSync(categoryPath).forEach(file => {
    ...
    // Prioritas: meta dari file JS > ENDPOINT_META map > default
...
// Expose daftar endpoint ke frontend
