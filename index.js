...
const ENDPOINT_META = {
  'editimage':        { param: 'prompt',   desc: 'Edit gambar dengan AI (?prompt=deskripsi&url=link_gambar)',  placeholder: 'ubah background jadi pantai' },
...
fs.readdirSync(apiDir).forEach(category => {
  ...
  fs.readdirSync(categoryPath).forEach(file => {
    ...
    endpoints.push({
      ...
      params:      fileMeta.params      ?? null,   // <-- expose params array kalau ada
    });
